...
public interface AppInstanceScanner {
	 ...
	 */
	List<Instance> determineInstancesFromTargets(List<Target> targets, @Null Predicate<? super String> applicationIdFilter, @Null Predicate<? super Instance> instanceFilter);
