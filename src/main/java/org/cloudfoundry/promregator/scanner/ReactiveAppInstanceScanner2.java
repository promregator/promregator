...
public class ReactiveAppInstanceScanner2 implements AppInstanceScanner {
	
	private static final Logger log = Logger.getLogger(ReactiveAppInstanceScanner2.class);
