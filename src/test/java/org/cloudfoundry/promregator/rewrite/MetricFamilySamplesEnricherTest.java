...
public class MetricFamilySamplesEnricherTest {
	...
	@Test
	public void testOwnMetricsSimple() {
		AbstractMetricFamilySamplesEnricher subject = new CFOwnMetricsMetricFamilySamplesEnricher("testOrgName", "testSpaceName", "testComponent", "testInstance:42");
	...
	@Test
	public void testInstanceOnlySimple() {
		AbstractMetricFamilySamplesEnricher subject = new CFInstanceOnlyMetricFamilySamplesEnricher("testInstance:42");
