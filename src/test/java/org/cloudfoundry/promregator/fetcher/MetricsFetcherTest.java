...
public class MetricsFetcherTest {
	...
	public void testStraightForward() throws Exception {
		...
		CFMetricsFetcher subject = new CFMetricsFetcher("http://localhost:9002/metrics", instanceId, null, dummymfse, new MetricsFetcherMetrics(dummymfse, null, null, null));
	...
	public void testAEIsCalled() throws Exception {
		...
		NullMetricFamilySamplesEnricher dummymfse = new NullMetricFamilySamplesEnricher("dummy", "dummy", "dummy", "dummy:0");
		CFMetricsFetcher subject = new CFMetricsFetcher("http://localhost:9002/metrics", instanceId, ae, dummymfse, new MetricsFetcherMetrics(dummymfse, null, null, null));
