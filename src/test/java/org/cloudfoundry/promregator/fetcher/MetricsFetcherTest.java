...
public class MetricsFetcherTest {
	...
	public void testStraightForward() throws Exception {
		...
		MetricsFetcher subject = new MetricsFetcher("http://localhost:9002/metrics", instanceId, null, dummymfse, new MetricFetcherMetrics(new String[0], null, null, null));
	...
	public void testAEIsCalled() throws Exception {
		...
		NullMetricFamilySamplesEnricher dummymfse = new NullMetricFamilySamplesEnricher("dummy", "dummy", "dummy", "dummy");
		MetricsFetcher subject = new MetricsFetcher("http://localhost:9002/metrics", instanceId, ae, dummymfse, new MetricFetcherMetrics(new String[0], null, null, null));
