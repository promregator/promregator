...
public class MetricsFetcherTest {
	...
	public void testStraightForward() throws Exception {
		...
		CFMetricsFetcher subject = new CFMetricsFetcher("http://localhost:9002/metrics", instanceId, null, dummymfse, new MetricFetcherMetrics(dummymfse, null, null, null));
	...
	public void testAEIsCalled() throws Exception {
		...
		NullMetricFamilySamplesEnricher dummymfse = new NullMetricFamilySamplesEnricher("dummy", "dummy", "dummy", "dummy");
		CFMetricsFetcher subject = new CFMetricsFetcher("http://localhost:9002/metrics", instanceId, ae, dummymfse, new MetricFetcherMetrics(dummymfse, null, null, null));
