...
public class ReactiveCFPaginatedRequestFetcherTest {
	...
	static {
		...
		responseGeneratorV3 = (data, numberOfPages) ->
			org.cloudfoundry.client.v3.organizations.ListOrganizationsResponse.builder()
				.resources(data)
				.pagination(Pagination.builder().totalPages(numberOfPages).totalResults(data.size()).build())
				.build();
	...
	@Test
	public void testEmptyResponseV3() {
		ReactiveCFPaginatedRequestFetcher subject = new ReactiveCFPaginatedRequestFetcher(this.internalMetricsMocked, Double.MAX_VALUE, Duration
			.ofMillis(100));
		...
		Mono<org.cloudfoundry.client.v3.organizations.ListOrganizationsResponse> subjectResponseMono = subject
			.performGenericPagedRetrievalV3(RequestType.OTHER, "nokey", requestGeneratorV3, request -> {
				org.cloudfoundry.client.v3.organizations.ListOrganizationsResponse response = org.cloudfoundry.client.v3.organizations.ListOrganizationsResponse
					.builder()
					.resources(new LinkedList<>())
					.pagination(Pagination.builder().totalPages(1).totalResults(0).build())
					.build();
	...
	@Test
	public void testWithContentOnePageV3() {
		ReactiveCFPaginatedRequestFetcher subject = new ReactiveCFPaginatedRequestFetcher(this.internalMetricsMocked, Double.MAX_VALUE, Duration
			.ofMillis(100));
	...
	@Test
	public void testWithContentTwoPagesV3() {
		ReactiveCFPaginatedRequestFetcher subject = new ReactiveCFPaginatedRequestFetcher(this.internalMetricsMocked, 0, Duration.ofMillis(100));
		...
		Mono<org.cloudfoundry.client.v3.organizations.ListOrganizationsResponse> subjectResponseMono = subject
			.performGenericPagedRetrievalV3(RequestType.OTHER, "nokey", requestGeneratorV3, request -> {
				...
				org.cloudfoundry.client.v3.organizations.ListOrganizationsResponse response = org.cloudfoundry.client.v3.organizations.ListOrganizationsResponse
					.builder()
					.resources(list)
					.pagination(Pagination.builder().totalPages(2).totalResults(2 * request.getPerPage()).build())
					.build();
	...
	@Test
	public void testWithContentTwoPagesSecondWithoutItemsV3() {
		ReactiveCFPaginatedRequestFetcher subject = new ReactiveCFPaginatedRequestFetcher(this.internalMetricsMocked, Double.MAX_VALUE, Duration
			.ofMillis(100));
	...
	@Test
	public void testWithContentTimeoutOnFirstPageV3() {
		ReactiveCFPaginatedRequestFetcher subject = new ReactiveCFPaginatedRequestFetcher(this.internalMetricsMocked, Double.MAX_VALUE, Duration
			.ofMillis(100));
	...
	public void testWithContentTimeoutOnSecondPage() {
		...
		ListOrganizationsResponse subjectResponse = subjectResponseMono.doOnError(e -> Assertions.assertTrue(Exceptions.unwrap(e) instanceof TimeoutException)
		).onErrorReturn(fallback).block();
		Assertions.assertEquals(fallback, subjectResponse);
	}

	@Test
	public void testWithContentTimeoutOnSecondPageV3() {
		ReactiveCFPaginatedRequestFetcher subject = new ReactiveCFPaginatedRequestFetcher(this.internalMetricsMocked, Double.MAX_VALUE, Duration
			.ofMillis(100));
		...
		org.cloudfoundry.client.v3.organizations.ListOrganizationsResponse subjectResponse = subjectResponseMono
				.doOnError(e -> Assertions.assertTrue(Exceptions.unwrap(e) instanceof TimeoutException)
		).onErrorReturn(fallback).block();
		Assertions.assertEquals(fallback, subjectResponse);
	}
	...
	public void testWithContentGeneralException() {
		...
		ListOrganizationsResponse subjectResponse = subjectResponseMono.doOnError(e -> Assertions.assertTrue(Exceptions.unwrap(e) instanceof Exception)
		).onErrorReturn(fallback).block();
		Assertions.assertEquals(fallback, subjectResponse);
	}

	@Test
	public void testWithContentGeneralExceptionV3() {
		ReactiveCFPaginatedRequestFetcher subject = new ReactiveCFPaginatedRequestFetcher(this.internalMetricsMocked, Double.MAX_VALUE, Duration
			.ofMillis(100));
		...
		org.cloudfoundry.client.v3.organizations.ListOrganizationsResponse subjectResponse = subjectResponseMono
				.doOnError(e -> Assertions.assertTrue(Exceptions.unwrap(e) instanceof Exception)
		).onErrorReturn(fallback).block();
		Assertions.assertEquals(fallback, subjectResponse);
	}
