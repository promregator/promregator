...
It is the "small proxy server" in the sense of the issue [prometheus/prometheus#2346](prometheus/prometheus#2346) (NB: due to the rejection of this issue, Promregator also cannot be implemented as a Prometheus' discovery service).
